...
export const getGetPublicSettingsQueryKey = () => {
  return [`/api/menu/settings`] as const;
};
...
export const listFeaturedDishes = async (
  options?: RequestInit,
): Promise<Dish[]> => {
...
export const getListFeaturedDishesQueryOptions = <
  TData = Awaited<ReturnType<typeof listFeaturedDishes>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listFeaturedDishes>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listFeaturedDishes>>
  > = ({ signal }) => listFeaturedDishes({ signal, ...requestOptions });
...
export type ListFeaturedDishesQueryResult = NonNullable<
  Awaited<ReturnType<typeof listFeaturedDishes>>
>;
...
export function useListFeaturedDishes<
  TData = Awaited<ReturnType<typeof listFeaturedDishes>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const adminListDishes = async (
  options?: RequestInit,
): Promise<Dish[]> => {
...
export const getAdminListDishesQueryKey = () => {
  return [`/api/admin/dishes`] as const;
};

export const getAdminListDishesQueryOptions = <
  TData = Awaited<ReturnType<typeof adminListDishes>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof adminListDishes>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof adminListDishes>>> = ({
    signal,
  }) => adminListDishes({ signal, ...requestOptions });
...
export type AdminListDishesQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminListDishes>>
>;
...
export function useAdminListDishes<
  TData = Awaited<ReturnType<typeof adminListDishes>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const toggleDishStock = async (
  id: number,
  options?: RequestInit,
): Promise<Dish> => {
...
export const getToggleDishStockMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ToggleDishStockMutationResult = NonNullable<
  Awaited<ReturnType<typeof toggleDishStock>>
>;
 ...
 * @summary Toggle dish availability (in/out of stock)
 */
export const useToggleDishStock = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
